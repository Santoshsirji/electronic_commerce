...
const LocationPage = () => {
    return (
        <div className="lg:flex pt-12 space-y-8 gap-8">
            <Card className="">
                <div className="md:flex space-between py-10">
                    ...
                    <CardContent>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.2544190067733!2d85.32405447614113!3d27.709429925398325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb19091da0e19b%3A0xc4598923d9d99381!2sCity%20Centre!5e0!3m2!1sen!2snp!4v1716075353626!5m2!1sen!2snp" width="600" height="450" style={{ border: 0 }} className="w-full h-80 md:h-96 md:w-96" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    </CardContent>
                </div>
            </Card>
        </div>
